...
import SubmitResume from "@candidate/pages/SubmitResume";
...
import JobSeekerAuth from "@candidate/pages/JobSeekerAuth";
import JobSeekerDashboard from "@candidate/pages/JobSeekerDashboard";
...
import SuperAdmin from "@admin/pages/SuperAdmin";
