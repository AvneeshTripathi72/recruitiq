...
const SubmitResume = React.lazy(() => import("@/pages/candidate/SubmitResume"));
...
const JobSeekerAuth = React.lazy(() => import("@/pages/candidate/JobSeekerAuth"));
const JobSeekerDashboard = React.lazy(() => import("@/pages/candidate/JobSeekerDashboard"));
